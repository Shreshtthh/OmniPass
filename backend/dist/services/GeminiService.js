...
class GeminiService {
    ...
    async analyzeUserActivity(data) {
        try {
            if (!this.apiKey) {
...
Keep responses accurate to the enhanced analysis methodology.`;
    ...
    determineAccessLevel(totalTvl, avgHealth, chainCount) {
    ...
    determineAccessLevelWithScore(totalTvl, avgHealth, chainCount, overallScore) {
